...
&lt;/div&gt;</code></pre>
				...
				<div class="loadMore text-center"><a href="features.html">See more</a></div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="documentation">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="info3">
							<p>Tutorial: <a href="tutorial/index.html" class="text-blue" target="blank_">Weather</a>, <a href="tutorial-portlet/index.html" class="text-blue" target="blank_">JuZcret</a> </p>
							<p>Guide: <a href="reference/index.html" class="text-blue" target="blank_">Reference</a>, <a href="extension/index.html" class="text-blue" target="blank_">Extension</a></p>
							<p>Doc: <a href="javadoc/index.html" class="text-blue" target="blank_">Javadoc</a></p>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-8">
						<div class="info3">
							<p>Tutorial: <a href="0.6.2/tutorial/index.html" class="text-blue" target="blank_">Weather</a></p>
							<p>Guide: <a href="0.6.2/reference/index.html" class="text-blue" target="blank_">Reference</a></p>
							<p>Doc: <a href="0.6.2/javadoc/index.html" class="text-blue" target="blank_">Javadoc</a></p>
						</div>
					</div>
				</div>
			</div>
